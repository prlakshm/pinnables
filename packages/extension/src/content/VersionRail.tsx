...
export function VersionLayer({
  ...
  useEffect(() => {
    ...
    const down = (e: KeyboardEvent) => {
      ...
      /*
       * By code, not key: on a Mac Option+2 types "™". Chrome often reports
       * that keydown with altKey false — versionJumpDigit still matches the glyph.
       */
      ...
      /*
       * Spec (toggle-redesign): arrows step the main rail when the
       * annotation draft is empty. They must not steal a caret in a
       * page field or a draft that already has words.
       */
      if (
